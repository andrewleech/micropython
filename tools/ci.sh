...
function ci_unix_macos_run_tests {
    ...
    # - thread/stress_heap.py, thread/thread_gc1.py: handled by run-tests.py flaky retry
...
function ci_unix_qemu_mips_run_tests {
    ...
    # - thread/stress_recurse.py, thread/thread_gc1.py: handled by run-tests.py flaky retry
...
function ci_unix_qemu_riscv64_run_tests {
    ...
    # - thread/stress_aes.py takes ~180s vs 200s timeout; excluded to avoid burning CI time on retries
    # - thread/stress_recurse.py, thread/thread_gc1.py: handled by run-tests.py flaky retry
    file ./ports/unix/build-coverage/micropython
    pushd tests
    MICROPY_MICROPYTHON=../ports/unix/build-coverage/micropython MICROPY_TEST_TIMEOUT=200 \
        ./run-tests.py --exclude 'thread/stress_aes.py'
