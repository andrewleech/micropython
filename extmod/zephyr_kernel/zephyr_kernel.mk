...
# Depends on config header to ensure rebuild when CONFIG_* definitions change
$(BUILD)/zephyr_offsets.o: $(ZEPHYR_OFFSETS_C) $(BUILD)/zephyr_gen_root/zephyr/version.h $(ZEPHYR_CONFIG_HEADER)
	@echo "CC (Zephyr offsets) $<"
	$(Q)$(CC) $(CFLAGS) $(ZEPHYR_INC) $(ZEPHYR_CFLAGS) $(ZEPHYR_OFFSETS_EXTRA_CFLAGS) -c -o $@ $<
...
ZEPHYR_ARCH_SRC_S := \
	...
	$(ZEPHYR_KERNEL)/zephyr_psp_switch.S
