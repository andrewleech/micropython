...
const timer_cfg_t g_timer_periodic_cfg =
{
    ...
    /* Actual period: 1.3981013333333334 seconds. Actual duty: 0%. */ .period_counts = (uint32_t) 0x10000, .duty_cycle_counts = 0x0, .source_div = (timer_source_div_t)10,
    .channel             = 8,
    .p_callback          = NULL,
...
{
    .p_ctrl        = &g_timer_periodic_ctrl,
    .p_cfg         = &g_timer_periodic_cfg,
