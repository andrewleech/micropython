...
#ifndef MICROPY_HW_BOARD_MIMXRT1060_EVK_USBHOST
#define MICROPY_HW_BOARD_MIMXRT1060_EVK_USBHOST

// Include base board configuration.
#include "../MIMXRT1060_EVK/mpconfigboard.h"

// Override board name.
#undef MICROPY_HW_BOARD_NAME
#define MICROPY_HW_BOARD_NAME "i.MX RT1060 EVK (USB Host)"
...
#endif // MICROPY_HW_BOARD_MIMXRT1060_EVK_USBHOST
