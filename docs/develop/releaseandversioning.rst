...
The ``1.x`` line aims to preserve the documented Python-level API that existing programs use. This
is deliberate. It does not imply stability for internal or C-level interfaces.
