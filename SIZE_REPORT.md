...
|--------------|------------------|--------|----------|
| Baseline (no enum) | 368,280 | - | - |
| With enum_minimal.py frozen | 370,820 | +2,540 | +0.69% |
...
2. **Frozen Python Module**: The enum_minimal.py module when frozen as bytecode adds 2,540 bytes (2.5 KB), which is remarkably compact for the functionality provided.
